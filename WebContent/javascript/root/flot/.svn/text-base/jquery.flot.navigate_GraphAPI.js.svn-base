...
(function ($) {
    ...
    function init(plot) {
        function bindEvents(plot, eventHolder) {
            ...
            if (o.zoom.interactive) {
                function clickHandler(e, zoomOut) {
                    ...
                    c.top = e.pageY - c.top;
                    if (zoomOut) {
                        plot.syncData = { isZoomOut: true, center: c, panLeft: plot.syncData.panLeft, panTop: plot.syncData.panTop };
                        plot.zoomOut({ center: c });
                    }
                    else
                    {
                        plot.syncData = { isZoomOut: false, center: c, panLeft: plot.syncData.panLeft, panTop: plot.syncData.panTop };
                        plot.zoom({ center: c });
                    }
                }
            ...
            if (o.pan.interactive) {
                ...
                eventHolder.bind("dragend", function (e) {
                    ...
                    plot.syncData = { isZoomOut: plot.syncData.isZoomOut, center: plot.syncData.center, panLeft: pageX - e.pageX, panTop: pageY - e.pageY };
        ...
        plot.syncData = { isZoomOut: true, center: { left: 0, top: 0 }, panLeft: 0, panTop: 0 };
