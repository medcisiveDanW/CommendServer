    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function measureTickLabels(axis) {
            ...
            function makeDummyDiv(labels, width) {
                return $('<div style="position:absolute;top:-10000px;' + width + 'font-size:' + fontSize + '">' +
        ...
        function insertAxisLabels() {
            ...
            var html = ['<div class="tickLabels" style="font-size:' + fontSize + '">'];
        ...
        function insertLegend() {
            ...
            var table = '<table style="font-size:' + fontSize + ';color:' + options.grid.color + '">' + fragments.join("") + '</table>';
